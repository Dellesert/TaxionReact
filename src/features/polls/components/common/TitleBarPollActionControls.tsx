 ...
 * Компактные кнопки действий для отображения в Electron TitleBar (опросы)
 */
...
interface TitleBarPollActionControlsProps {
...
export const TitleBarPollActionControls: React.FC<TitleBarPollActionControlsProps> = ({
  hasActiveFilters,
  onFilterToggle,
