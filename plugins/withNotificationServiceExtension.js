 ...
 * uses Communication Notifications (INSendMessageIntent) to display
 * the sender avatar on the left with the app icon badge on the bottom-right.
 * Also downloads attachment thumbnails to show media preview on the right side.
 *
